...
abstract class $AddressCopyWith<$Res> {
  ...
  @useResult
  $Res call({String address_name, String lat, String lon});
}
...
class _$_Address with DiagnosticableTreeMixin implements _Address {
  _$_Address(
      {required this.address_name, required this.lat, required this.lon});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Address(address_name: $address_name, lat: $lat, lon: $lon)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, address_name, lat, lon);
...
abstract class _Address implements Address {
  factory _Address(
      ...
      required final String lon}) = _$_Address;
