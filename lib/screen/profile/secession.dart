  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('탈퇴신청',style: TextStyle(color: Colors.black,fontWeight: FontWeight.w600),),
        centerTitle: true,
        actions: null,
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("사유",style: TextStyle(color: Colors.black,fontSize: 14,fontWeight: FontWeight.w600),),
            SizedBox(height: 10.0,),
            Container(
            ...
            SizedBox(height: 10.0,),
            Text('*200자 내로 입력 가능합니다.',style: TextStyle(color: Colors.red),),
            Spacer(),
            Container(
...
void _secession(BuildContext context) {
  showCupertinoModalPopup<void>(
    ...
    builder: (BuildContext context) => CupertinoAlertDialog(
      content: Column(
        children: [
          Text('탈퇴신청', style: TextStyle(fontSize: 16,fontWeight: FontWeight.w600),),
          SizedBox(height: 12,),
